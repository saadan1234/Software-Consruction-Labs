...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    // You may use code that you wrote yourself or with your teammates
	    if (writtenByYourself) {
	        return true;
	    }

	    // If the code is available to others, it may be used if properly cited
	    if (!writtenByYourself && availableToOthers && citingYourSource) {
	        return true;
	    }

	    // If the code was written as coursework, it may be used if properly cited
	    if (!writtenByYourself && writtenAsCourseWork && citingYourSource) {
	        return true;
	    }

	    // If the code is not written by yourself but is required for implementation,
	    // it may be used if it's available to others and properly cited
	    if (!writtenByYourself && implementationRequired && availableToOthers && citingYourSource) {
	        return true;
	    }
